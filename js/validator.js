...
+(function ($) {
  ...
  Validator.prototype.showErrors = function ($el) {
    ...
    if ($group.hasClass("has-feedback")) {
      $feedback
        ...
        .addClass(this.options.feedback.error);
  ...
  Validator.prototype.toggleSubmit = function () {
    ...
    var $btn = this.$btn;
    var isValid = this.$inputs.toArray().every(function (el) {
      return $(el).data("bs.validator.errors") === undefined;
    });
  ...
  Validator.prototype.reset = function () {
    ...
    this.clearErrors(this.$inputs);
    this.$inputs.removeData([
      "bs.validator.errors",
  ...
  Validator.prototype.destroy = function () {
    ...
    this.$btn.off(".bs.validator");

    this.$element.find(".help-block.with-errors").each(function () {
      var $this = $(this);
      var originalContent = $this.data("bs.validator.originalContent");

      if (originalContent) $this.html(originalContent);
